...
<body>
    <div class="container mt-5">
        ...
        <div class="text-center mt-4">
            <a href="/TestCIIEA/actividades/third_grade/visual_activity.php" class="btn btn-primary">HAGAMOS ACTIVIDADES</a>
        </div>
    </div>
