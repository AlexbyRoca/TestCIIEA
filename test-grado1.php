...
$sqlPreguntas = "SELECT * FROM preguntas WHERE estatus='1'";
...
<nav id="navbar" class="navbar navbar-expand-lg navbar-light">
    <div class="container-fluid">
        <div class="logo-container">
            <img src="assets/imgs/tabedu.png" class="tabedu-logo" alt="logo 1">
            <img src="assets/imgs/logo.png" class="main-logo" alt="logo 2">
        </div>
...
<br><br>
<h4 class="text-center">Completa el test y al finalizar, haga clic en Enviar.</h4>
<hr>

<form id="formFormatoGS" action="assets/procesos/procesar_encuesta.php" method="POST">
                ...
                <?php 
                    ...
                    while ($dataRow = mysqli_fetch_array($query)) { ?>
                        <tr id="pregunta_<?php echo $dataRow['id']; ?>">
                            ...
                            <td><?php echo htmlspecialchars($dataRow['pregunta']); ?></td>
