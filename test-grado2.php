...
$sqlPreguntas = "SELECT * FROM preguntas1 WHERE status='0'";
...
<br><br>
        ...
        <form id="formFormatoGS" action="assets/procesos/procesar_encuesta_second_grade.php" method="POST">
                ...
                <?php 
                    ...
                    while ($dataRow = mysqli_fetch_array($query)) { ?>
                        <tr id="pregunta_<?php echo $dataRow['id']; ?>">
                            ...
                            <td><?php echo htmlspecialchars($dataRow['pregunta1']); ?></td>
